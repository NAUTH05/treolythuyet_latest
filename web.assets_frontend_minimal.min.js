...
odoo.define('@web/legacy/js/core/menu', async function(require) {
    ...
    async function initAutoMoreMenu(el, options) {
        ...
        function _adapt() {
            el.dispatchEvent(new Event("autoMoreMenu.willAdapt",{
                bubbles: true
            }));
...
odoo.define('@web/legacy/js/core/minimal_dom', async function(require) {
    ...
    function makeButtonHandler(fct) {
        ...
        return function(ev) {
            ...
            Promise.resolve(DEBOUNCE && new Promise(r => setTimeout(r, DEBOUNCE))).then(function() {
    ...
    __exports.addButtonLoadingEffect = addButtonLoadingEffect;
    function addButtonLoadingEffect(btnEl) {
...
odoo.define('web.public.lazyloader', function(require) {
    'use strict';
    const {BUTTON_HANDLER_SELECTOR, makeAsyncHandler, makeButtonHandler, } = require('@web/legacy/js/core/minimal_dom');
